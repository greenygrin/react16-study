...
class MyClass1 {
    ...
    // 이름이 고정되어 있다
    constructor() {
        // 모드 멤버변수는 "this."을 명시하며 "_"로 시작하는 것이 관례
        this._num1 = 1;
        this._num2 = 2;
    }
}
...
console.log(my3.num1);         // getter를 통해 멤버변수에 간접적으로 리턴 받음
my3.num1 = 1;
...
// 클래스를 통해서 동일한 변수구조와 기능을 갖는 객첼를 여러개 생성할 수 있다
const z1 = new Zealot();
z1.name = "질럿1";
z1.power = 50;
...
// 이런 것이 잘 표현된 것이 게임 (버튼마다 다 다른 명령 수행)
// 버튼 --> 변수 : 넓이, 높이, 색상, 텍스트
//          동작 : 클릭 시 수행할 기능 <== 콜백