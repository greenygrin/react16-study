...
import { withRouter } from 'react-router-dom';  // 라우트가 아닌 컴포넌트에서 라우터를 사용할 떄
...
// 컴포넌트를 내보낼 때 withRouter라는 함수로 가공하면 이 컴포넌트로 전달되는 props에는 location, match, history 등의 Router 객체가 포함도니다.
